...
export default function Navbar() {
    return (
        <nav class={`navbar navbar-expand-lg bg-body-tertiary fixed-top border-bottom shadow-sm ${style.navbar} `}>
            <a class={`navbar-brand text-white ${style.Logo} `} href="#">User Navbar</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto me-5 mb-2 mb-lg-0">
                    ...
                    <li className={`nav-item`}>
                        <Link class="nav-link" to="Settings"><Avatar src='img/image1.jpg' className='shadow-sm ' style={{ width: '32px', height: '32px' }} alt='' /></Link>
                    </li>
                </ul>
            </div>
        </nav>
